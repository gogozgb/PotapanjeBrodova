...
{
    [TestClass]
    public class TestKružitelja
    {
        [TestMethod]
        public void Kružitelj_DajKandidate_VraćaSvaOkolnaPoljaAkoSuDuljineNizovaUNastavkuVećeOdDuljineBroda()
        {
            Mreža mreža = new Mreža(10, 10);
            Polje pogođenoPolje = new Polje(2, 2);
            Kružitelj pucač = new Kružitelj(mreža, 3, pogođenoPolje);
        ...
        [TestMethod]
        public void Kružitelj_DajKandidate_VraćaSamoPoljeUSmjeruUKojemJeDuljinaNizaVećaOdDuljineBroda()
        {
            Mreža mreža = new Mreža(10, 10);
        ...
        [TestMethod]
        public void Kružitelj_DajKandidate_VraćaPoljaUNajduljemSmjeruAkoSuDuljineNizovaManjeOdDuljineBroda()
        {
            Mreža mreža = new Mreža(10, 10);
            ...
            Polje pogođenoPolje = new Polje(2, 2);
            Kružitelj pucač = new Kružitelj(mreža, 4, pogođenoPolje);
            IEnumerable<Polje> kandidati = pucač.DajKandidate();
